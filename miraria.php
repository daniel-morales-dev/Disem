...
<html lang="es" xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php
		...
		<div id="contenido">
				...
				<tbody>
					<?php while($row=$resultado->fetch_assoc()){ ?>
						<tr>
							...
							<td>
								<center><a href="eliminarp2.php?id=<?php echo $row['id'];?>">Eliminar</a></center>
							</td>
						</tr>
			...
			<center><a href="inventarioa.php"><h4><center>Atras</center></h4></a></center>
			<form> 
					<center><input type='button' onclick='window.print();' value='Imprimir' /></center>
					</form> <p></p>
			<center><a href="editarpa.php"><h4><center>Editar Producto</center></h4></a></center>
					</hgroup>
				</div>
			</section>
		</div>
