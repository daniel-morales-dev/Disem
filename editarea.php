	...
	<?php
		...
		<div id="contenido">
			...
			<section>
				<div id="textopr">
					<hgroup>
						<center><h1>EDITAR EMPRESA</h1></center>
				<tbody>
					<?php
$var1="";
$var2="";
...
if(isset($_POST["btn1"])){
	...
	if($btn=="Buscar"){
		...
		$sql="select * from empresas where nit='$bus'";
		...
		$sql="update empresas set id='$id',empresa='$empresa',nit='$nit',encargado='$encargado',telefono='$telefono',email='$email' where id='$id'";
...
<tr>
<td><b>EMPRESA:</b></td>
<td><input type="text" name="empresa"  value="<?php echo $var2?>"/></td>
</tr>
<tr>
<td><b>NIT:</b></td>
<td><input type="text" name="nit" value="<?php echo $var3?>" /></td>
</tr>
<tr>
<td><b>ENCARGADO:</b></td>
<td><input type="text" name="encargado"  value="<?php echo $var4?>"/></td>
</tr>
<tr>
	<td>
		<b>TELEFONO:</b>
...
if(isset($_POST["btn1"])){
	...
	if($btn=="Listar"){
		...
		$cs=mysql_query($sql,$cn);
		echo "<script>location.href='mempresasa.php'</script>";
		echo"<center>
<table border='3'>
<tr>
<td>Usuario</td>
...
?>
					...
					<a href="mempresasa.php">Atras</a></p>
					</center>
					</hgroup>
				</div>
			</section>
