		...
		<div id="contenido">
			...
			<thead>
				<tr>
					...
					<td><center><b>DIA</b></td></center>
					<td><center><b>MES</b></td></center>
					<td><center><b>CANCELAR ENCARGO</b></td></center>
					<td><center><b>CONFIRMAR ENTREGA</b></td></center>
				</tr>
				<tbody>
					<?php while($row=$resultado->fetch_assoc()){ ?>
						<tr>
							...
							<td>
								<center><a href="eliminar.php?id=<?php echo $row['id'];?>">CANCELAR</a></center>
							</td>
							<td>
								<center><a href="confirmar.php?id=<?php echo $row['id'];?>">CONFIRMAR</a></center>
							</td>
						</tr>
					...
					<center>
						<a href="encargar.php"><h4><center>Atras</center></h4></a>
						<form> 
